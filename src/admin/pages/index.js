...
import ExamManage from './Exam/ExamManage';
...
function AdminPage(props) {
	...
	return (
		<Switch>
			...
			<Route exact path = {`${match.url}/examsearch`} render={(props) => <ExamSearch {...props} /> } />
			<Route exact path = {`${match.url}/exammanage`} render={(props) => <ExamManage {...props} /> } />
			<Route exact path = {`${match.url}/examcreate`} render={(props) => <ExamCreate {...props} /> } />

			<Route exact path = {`${match.url}/createnotice`} render={(props) => <CreateNotice {...props} /> } />
