...
function DashboardLayout(props) {
	...
	const [noticeClass, setNoticeClass] = useState(false);
			...
			<div className="left-body">
				...
				<div className="left-body__nav">
					<ul>
						...
						<li onClick={() => setExamClass(!examClass)}><Link to="#"><i className="fa fa-pencil-square-o" ></i> 시험 </Link>
							{
								examClass &&
                                <ul style={{marginLeft: '15px'}}>
                                	<li onClick={() => setExamClass(!examClass)}><Link to="/admin/examsearch"><i className="fa fas fa-laptop"></i> 결과 조회</Link></li>
                                	<li onClick={() => setExamClass(!examClass)}><Link to="/admin/exammanage"><i className="fa fas fa-list-ol"></i> 시험 수정</Link></li>
                                	<li onClick={() => setExamClass(!examClass)}><Link to="/admin/examcreate"><i className="fa fa-check-square-o"></i> 시험 생성</Link></li>
                                </ul>
							}
						</li>
						<li onClick={() => setNoticeClass(!noticeClass)}><Link to="#"><i className="fa fa-pencil-square-o" ></i> 공지사항 </Link>
							{
								noticeClass &&
                                <ul style={{marginLeft: '15px'}}>
                                	<li onClick={() => setNoticeClass(!noticeClass)}><Link to="/admin/createnotice"><i className="fa fas fa-laptop"></i> 프로그래밍 문제</Link></li>
                                </ul>
							}
						</li>
					</ul>
