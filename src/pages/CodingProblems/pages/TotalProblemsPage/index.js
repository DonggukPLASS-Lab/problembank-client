...
function TotalProblemsPage(props) {
	...
	React.useEffect(() => {
		...
		// let { page } = qs.parse(window.location.search.slice(1));
		// if(page === undefined){

		// }else{
		// 	let params = {
		// 		page,
		// 		limitPage: countDisplayProblem
		// 	}
		// 	const request = problemAPI.getProblemforPage(params);
